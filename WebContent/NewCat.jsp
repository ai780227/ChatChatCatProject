...
<body style="overflow-x:hidden;">
	...
	<form id="personalform" action="<c:url value='/CreateCatInfoServlet.do'/>" method="POST" enctype="multipart/form-data"
		...
		<p style="border-bottom:none;"> 出生年：
			<input type="text" id="c_age" name="c_age" style="border:0; font-size: 16px; font-family: '微軟正黑體'; background:transparent;">
