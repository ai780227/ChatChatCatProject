...
<input type="hidden" id="opennewpost" class="buttonClass">

<div class="post"></div>

<script type="text/javascript">
var page = 0, size = 5;
var post_type = 2, post_property = 0;
var user = null;
var user_id = "${user.getM_id()}";
var manager = "${manager}";
var mPostURL = "<c:url value='/ViewPostsByManagerServlet.mgr'/>";
...
<script src="<c:url value='/js/mpost.js'/>"></script>
